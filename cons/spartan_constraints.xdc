...
## LEDs
set_property -dict { PACKAGE_PIN E18   IOSTANDARD LVCMOS33 } [get_ports { basic_led }]; #IO_L16N_T2_A27_15 Sch=led[2]
...
## Buttons
# we're using button 0 (G15) as a reset button
set_property -dict { PACKAGE_PIN G15   IOSTANDARD LVCMOS33 } [get_ports { reset_button }]; #IO_L18N_T2_A23_15 Sch=btn[0]
